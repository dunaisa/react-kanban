...
const SubTask = ({styleType} : SubTaskProps) => {
  return (
    <li className={`subtask-item subtask-item--${styleType}`}>
      <button className='subtask-item__status'>
      ...
      <span className={`subtask-text subtask-text--${styleType}`}>
        Разработать прототип
      </span>
      <div className={`subtask-user-ava subtask-user-ava--${styleType}`}>
